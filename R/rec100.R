...
#' }
#'
#' @source \url{https://physionet.org/physiobank/database/mitdb/}, (\href{https://dx.doi.org/10.13026/C2F305}{doi:10.13026/C2F305}).
#'
...
# rec100 <- dat[1:108000,]    # 5 min * 60 s * 360 Hz
# usethis::use_data(rec100)
